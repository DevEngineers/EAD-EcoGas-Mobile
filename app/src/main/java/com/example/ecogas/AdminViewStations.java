...
public class AdminViewStations extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_stations);
    ...
    private void logOut() {
        ...
        Intent intent = new Intent(AdminViewStations.this, MainActivity.class);
        startActivity(intent);
    }

    private void editProfile() {
        /** Redirecting to edit profile via Intent **/
        Intent intent = new Intent(AdminViewStations.this, EditProfile.class);
        startActivity(intent);
    }
